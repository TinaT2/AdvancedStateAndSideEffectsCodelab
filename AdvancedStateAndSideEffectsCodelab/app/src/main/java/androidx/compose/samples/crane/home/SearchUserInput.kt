...
fun ToDestinationUserInput(onToDestinationChanged: (String) -> Unit) {
    val editable = rememberEditableUserInputState(hint = "Choose Destination")
    ...
    LaunchedEffect(editable){
       snapshotFlow { editable.text }
           .filter { !editable.isHint }
           .collect {
               currentOnDestinationChanged(editable.text)
           }
    }
}
